...
public class Noder {
	...
	private String noderType;        //节点用户类别
	private String noderState;       //节点状态
	...
	public String getNoderState() {
		return noderState;
	}
	public void setNoderState(String noderState) {
	...
	public String toString() {
		return "Noder [id=" + id + ", noderName=" + noderName + ", idNumber="
				+ idNumber + ", email=" + email + ", password=" + password
				+ ", noderImg=" + noderImg + ", noderProvince=" + noderProvince
				+ ", noderCity=" + noderCity + ", noderCounty=" + noderCounty
				+ ", noderAddress=" + noderAddress + ", noderKey=" + noderKey
				+ ", noderType=" + noderType + ", noderState=" + noderState
				+ ", business=" + business + ", registerStart=" + registerStart
				+ ", applyTime=" + applyTime + ", companyName=" + companyName
				+ ", companyId=" + companyId + ", companyCode=" + companyCode
				+ ", lawerName=" + lawerName + ", companyRegist="
				+ companyRegist + ", noderFile=" + noderFile + ", record="
				+ record + ", nodeCount=" + nodeCount + ", nodeIp=" + nodeIp
				+ ", chainCount=" + chainCount + ", chainId=" + chainId
				+ ", nodePubKey=" + nodePubKey + ", nodePrivateKey="
				+ nodePrivateKey + ", noderEnd=" + noderEnd + ", upReason="
				+ upReason + ", endReason=" + endReason + ", protectRecord="
				+ protectRecord + ", rawmaterials="
				+ rawmaterials + ", purchases=" + purchases +",authority="+ authority
				+ "]";
	}
