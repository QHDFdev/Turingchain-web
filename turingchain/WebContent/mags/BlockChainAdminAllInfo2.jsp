          ...
          <div class="box box-info">
            ...
            <form class="form-horizontal">
              ...
              <label class="col-sm-2 control-label"></label>
	              <div class="col-sm-1">
	              	<a href="<%=request.getContextPath()%>/deleteBlockChainAdmin/${bcAdmin.id}.do" class="delete"><button type="button" class="btn btn-block btn-success btn-info ">删除</button></a>
	              </div>
              </div>
              </div>
              </form>
